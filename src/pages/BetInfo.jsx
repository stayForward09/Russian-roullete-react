    ...
    return(
        <div className=" h-screen w-screen bg-[#141117]">
            <div className=" z-10 fixed inset-0 sm:w-full md:w-4/5 lg:w-3/5 xl:w-2/5  ml-auto mr-auto">
                ...
                <div className={`bg-[#2C3137] ${isExpanded?'h-[90%]':'h-[43%]'} rounded-xl text-center items-center py-4`}>
                    <div className="flex w-full">
                        <label className="mb-5 ml-5 text-xl font-bold text-white text-left">BET INFORMATION</label>
                    ...
                    <div className="mb-4">
                        ...
                        <div className="text-white font-semibold text-base">Username : <span className="text-[#f8bf60]">gvjt6400</span></div>
                        <div>Satureday 24 November 2025 at 17:02:52 GMT</div>
                        <div className="text-white text-base -mt-2">18 Hours Ago</div>
                        </div>
                        <div className=" rounded-lg bg-black mx-8 divide-x-2 divide-[#2C3137] grid grid-cols-3 gap-1">
                            <div className=" items-center mt-auto mb-auto">
                                <div className="text-lg text-white font-bold">Bet</div>
                                <div className="text-xl text-[#f8bf60] font-bold flex justify-center"><img src={Dia} className="w-5 h-5 mt-1 mr-2" alt='dia'/>50,000</div>
                            </div>
                            <div className=" mt-auto mb-auto">
                                <div className="text-lg text-white font-bold">Multiplier</div>
                                <div className="text-xl text-[#f8bf60] font-bold">25.00x</div>
                            </div>
                            <div className=" items-center mt-auto mb-auto ">
                                <div className="text-lg text-white font-bold">Payout</div>
                                <div className="text-xl text-[#f8bf60] font-bold flex justify-center"><img src={Dia} className="w-5 h-5 mt-1 mr-2" alt='dia'/>750,000.00</div>
                            </div>
                        </div>
                    ...
                    <div className="mb-4 px-4 text-white space-y-1 overflow-y-auto h-[38%] lg:h-[35%]">
                        <div className="flex  text-sm text-black font-semibold space-x-0.5"><span className="hidden md:block bg-[#f8bf60] w-[20%] px-2 rounded-tl-md">ROUNDED</span><span className="bg-[#f8bf60] w-[25%]  md:w-[20%] px-2 rounded-tl-md md:rounded-none">BET</span><span className="hidden md:block bg-[#f8bf60]  w-[15%] px-2">RESULT</span><span className="bg-[#f8bf60]  md:w-[15%] w-[20%] px-2">TARGET</span><span className="bg-[#f8bf60] w-[20%] md:w-[15%] px-2">PAYOUT</span><span className="bg-[#f8bf60] rounded-tr-md w-[25%] md:w-[20%] px-2"><svg className="w-4 h-4 justify-center ml-auto mr-auto" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M13.5442 10.4558C11.8385 8.75022 9.07316 8.75022 7.36753 10.4558L4.27922 13.5442C2.57359 15.2498 2.57359 18.0152 4.27922 19.7208C5.98485 21.4264 8.75021 21.4264 10.4558 19.7208L12 18.1766" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M10.4558 13.5442C12.1614 15.2498 14.9268 15.2498 16.6324 13.5442L19.7207 10.4558C21.4264 8.75021 21.4264 5.98485 19.7207 4.27922C18.0151 2.57359 15.2497 2.57359 13.5441 4.27922L12 5.82338" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg></span></div>
                        
                        <div className="flex  text-sm text-white font-semibold space-x-0.5"><span className="hidden md:block bg-[#141117] w-[20%] px-2">1</span><span className="bg-[#141117] w-[25%]  md:w-[20%] px-2 flex justify-center"><img src={Dia} className="w-3 h-3 mt-1 mr-1" alt='dia'/>777,777.77</span><span className="hidden md:block bg-[#141117] text-white  w-[15%] px-2">200.00x</span><span className="bg-[#141117]  md:w-[15%] w-[20%] px-2 text-[#f8bf60]">75.00x</span><span className="bg-[#141117] w-[20%] md:w-[15%] px-2 justify-center flex text-[#f8bf60]"><img src={Dia} className="w-3 h-3 mt-1 mr-1" alt='dia'/>777,777.77</span><span className="bg-[#141117] w-[25%] md:w-[20%] px-2 text-[#f8bf60]">BET #777777777</span></div>
                        <div className="flex  text-sm text-white font-semibold space-x-0.5"><span className="hidden md:block bg-[#141117] w-[20%] px-2">2</span><span className="bg-[#141117] w-[25%]  md:w-[20%] px-2 flex justify-center"><img src={Dia} className="w-3 h-3 mt-1 mr-1" alt='dia'/>777,777.77</span><span className="hidden md:block bg-[#141117] text-white  w-[15%] px-2">10.00x</span><span className="bg-[#141117]  md:w-[15%] w-[20%] px-2 text-[#f8bf60]" >20.00x</span><span className="bg-[#141117] w-[20%] md:w-[15%] px-2 justify-center flex text-[#f8bf60]"><img src={Dia} className="w-3 h-3 mt-1 mr-1" alt='dia'/>200.00</span><span className="bg-[#141117] w-[25%] md:w-[20%] px-2 text-[#f8bf60]">BET #777777777</span></div>
